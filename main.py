...
min_dict = {time_list[0]: 400, time_list[1]: 2001, time_list[2]: 4001, time_list[3]: 6001, time_list[4]: 8001, time_list[5]: 10001, time_list[6]: 12001}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 2000, time_list[1]: 4000, time_list[2]: 6000, time_list[3]: 8000, time_list[4]: 10000, time_list[5]: 12000, time_list[6]: 16000}
# 设置结束
